...
"LotDescriptionsController" class
*/
...
const LotDescriptionsController = require('../../controllers/classroom_configurations/LotDescriptionsController.js');
  ...
  next();
   ...
   router.post('/add_lot_descriptions', urlencodedParser,function(request,response){
        ...
        var	jsonObject_ = {
          ...
          var myPromise = LotDescriptionsController.insert(jsonObject_);
   ...
   router.post('/get_all_lot_descriptions',urlencodedParser,function(request,response){
    ...
    var myPromise = LotDescriptionsController.get_all_records();
   ...
   router.post('/get_specific_lot_descriptions',urlencodedParser,function(request,response){
        ...
        var myPromise = LotDescriptionsController.get_specific_records(mKey,mValue);
   ...
   router.post('/update_lot_descriptions',urlencodedParser,function(request,response){
    ...
    var myPromise = LotDescriptionsController.batch_update(jsonObject_);
   ...
   router.post('/update_individual_lot_descriptions',urlencodedParser,function(request,response){
         ...
         var myPromise = LotDescriptionsController.individual_record_update(column_name,value_,jsonObject_);
   ...
   router.post('/delete_individual_lot_descriptions',urlencodedParser,function(request,response){
    ...
    var myPromise = LotDescriptionsController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
   ...
   router.post('/get_number_of_lot_descriptions_records',urlencodedParser,function(request,response){
    ...
    var myPromise = LotDescriptionsController.get_number_of_records(column_name,value_);
...
router.post('/lot_descriptions_user_specific_query',urlencodedParser,function(request,response){
    ...
    var myPromise = LotDescriptionsController.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
