  ...
  next();
   ...
   router.post('/update_individual_user_roles',urlencodedParser,function(request,response){
	   ...
	   var	jsonObject_ = {
         ...
         var myPromise = UserRolesController.individual_record_update(column_name,value_,jsonObject_);
   ...
   router.post('/delete_individual_user_roles',urlencodedParser,function(request,response){
    ...
    var myPromise = UserRolesController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
   ...
   router.post('/get_number_of_user_roles_records',urlencodedParser,function(request,response){
    ...
    var myPromise = UserRolesController.get_number_of_records(column_name,value_);
...
router.post('/user_roles_user_specific_query',urlencodedParser,function(request,response){
    ...
    var myPromise = UserRolesController.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
