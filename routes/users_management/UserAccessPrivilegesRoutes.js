...
const UserAccessPrivilegesController = require("../../controllers/users_management/UserAccessPrivilegesController.js");
...
router.post("/get_all_user_access_privileges", urlencodedParser, function(
  ...
  var myPromise = UserAccessPrivilegesController.get_all_records();
...
router.post(
  ...
  function(request, response) {
    ...
    var myPromise = UserAccessPrivilegesController.individual_record_update(
      column_name,
      value_,
      jsonObject_
    );
