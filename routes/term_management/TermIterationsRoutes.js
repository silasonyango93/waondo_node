...
const TermIterationsController = require('../../controllers/term_management/TermIterationsController.js');
  ...
  next();
   ...
   router.post('/add_term_iterations', urlencodedParser,function(request,response){
        ...
        var	jsonObject_ = {
			...
			TermIterationDescription:request.body.TermIterationDescription
