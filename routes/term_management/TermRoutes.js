...
router.use(function timeLog(req, res, next) {
  ...
  next();
   ...
   router.post('/get_specific_term',urlencodedParser,function(request,response){
   ...
   router.post('/update_individual_term',urlencodedParser,function(request,response){
	...
	var	jsonObject_ = {
         ...
         var myPromise = TermController.individual_record_update(column_name,value_,jsonObject_);
   ...
   router.post('/delete_individual_term',urlencodedParser,function(request,response){
    ...
    var myPromise = TermController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
   ...
   router.post('/get_number_of_term_records',urlencodedParser,function(request,response){
...
router.post('/term_user_specific_query',urlencodedParser,function(request,response){
    ...
    var myPromise = TermController.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
