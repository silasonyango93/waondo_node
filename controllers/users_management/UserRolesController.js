...
module.exports = class UserRolesController{
   ...
   static individual_record_update(ColumnName,value_,jsonObject_){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = UserRolesModel.individual_record_update(ColumnName,value_,jsonObject_);
   ...
   static delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = UserRolesModel.delete_user_specic_record(ColumnName,value_,UserIdColumnName,UserId);
   ...
   static get_number_of_records(ColumnName,value_){
	...
	static user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId){
	   return new Promise(function(resolve, reject) { 
		...
		var myPromise = UserRolesModel.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
